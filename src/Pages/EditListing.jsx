...
function EditListing() {
  ...
  //redirect if listing doen't belong to current user
  useEffect(() => {
  ...
  const onSubmit = async (e) => {
    ...
    //delete these because we'll get these from other source
    ...
    <div className="profile">
      ...
      <main>
        <form onSubmit={onSubmit}>
          ...
          {/* if offer show discounted price */}
          {offer && (
            <>
